...
import { AdditionalInfoPageProfileSection } from './AdditionalInfoPageProfileSection';
import { AdditionalInfoPageFormSection } from './AdditionalInfoPageFormSection';
      ...
      <div className="flex w-full flex-col items-center">
        ...
        >
          <CardContent className="px-8 py-10">
            {/* 프로필 이미지 */}
            <AdditionalInfoPageProfileSection
              profileImage={profileImage}
              onImageUpload={handleImageUpload}
            />

            {/* 폼 섹션 */}
            <AdditionalInfoPageFormSection
              formData={formData}
